    ...
    return(
      <div className="Post">
        ...
        {(interactMenu || interactionsHistoryMenu ) && (<div onClick={()=>{setInteractMenu(false)}} className="BackdropEffect"> </div>)}
            ...
            className="PostHead">
                  <div onClick={()=>{
                     if(postData.advertiser)
                     navigate(`/profile/${postData.advertiser.username}`)
                  }}>
                      <img src={imgSrc}></img>
                      <div>
            ...
            className="PostBody">
                ...
                {view &&( <motion.button
                 ...
                 {!isCreator && type=="Ordinary" && (<div className="SocialIcons">
                   <img src={xlogo}></img>
                 ...
                 {isCreator && ( <div className="PostControls SocialIcons">
