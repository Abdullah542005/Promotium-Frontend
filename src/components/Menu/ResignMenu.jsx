import { resign } from "../../services/validator"


export default function ResignMenu({closeMenu}){     //CSS LOADED FROM MENU.CSS
    return(
         <div className="Menu ResignMenu">
             <div>
               <h1 className="FontNormal">Resign</h1>
            ...
            <div className="ResignMenuBody">
               <h1>Your Stake will be unlocked after 1 day of resignation.Meanwhile you need to resolve all the pending reports.</h1>
              <div>
                <button onClick={()=>{closeMenu(false)}}>Cancel</button>
