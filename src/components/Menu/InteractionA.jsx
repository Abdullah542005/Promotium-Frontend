...
export default function InteractionA({closeMenu}) {
    return(
      <AnimatePresence>
         <motion.div 
         ...
         className="InteractionA Menu">
            <div>
             ...
             <div className="InteractATags">
                  <span><h2>Post Type: </h2> <h2 style={{color:"#01A1CD"}}>Ordinary</h2></span>
                  <span><h2>Post ID:</h2> <h2 style={{color:"#01A1CD"}}>49184</h2></span> 
                  <span><h2>Reward: </h2> <h2 style={{color:"#01A1CD"}} >5 PROMO</h2></span>
                  <span><h2>Interactions Left: </h2> <h2 style={{color:"#01A1CD"}}>1753</h2></span> 
             </div>
             ...
             <button>Verify And Claim</button>
         </motion.div>
         </AnimatePresence>
    )
}