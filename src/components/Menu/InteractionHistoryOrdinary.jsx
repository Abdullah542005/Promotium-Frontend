import './InteractionHistoryOrdinary.css'
import React from 'react'
import {motion,AnimatePresence} from "framer-motion"

const InteractionHistoryOrdinary = ({closeMenu}) => {
  return (
    <AnimatePresence>
        ...
        <motion.div 
         ...
         className="Menu NotificationMenuA" style={{gap:"18px"}}>
            ...
            <div className="Interactions">
                <div className="postType">Post Type: Ordinary</div>
                <div className="postID">Post ID: 49184</div>
                <div className="Reward">Reward: 5 PROMO</div>
                <div className="interactionLeft">Interactoins Left: 1753</div>
            </div>

            <div className="NTagWraper">
                <NotificationTag  head={"New Interaction"} body={"@faisal531 has interacted with your post id #3403."}
                 time={"5sec ago"}
                />
                <NotificationTag  head={"New Interaction"} body={"@abdullah451 has interacted with your post id #3403."}
                  time={"1hr ago"}
                />
                 <NotificationTag head={"New Interaction"} body={"@M.Atif has interacted with your post id #3403."}
                  time={"1 hr 45 min ago"}
                 />
                 <NotificationTag head={"New Interactoin"} body={"@iFaixal has intreacted with your post id #3403"}
                  time={"2 hr ago"}
                 />
            </div>
        </motion.div>
...
export default InteractionHistoryOrdinary

function NotificationTag({head,body,type, time}){
    return( 
